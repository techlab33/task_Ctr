...
class EditLink extends StatefulWidget {
  ...
  const EditLink({Key? key, required this.category, required this.title, required this.desc, required this.id}) : super(key: key);
  @override
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              minLines: 3,
                              style:  TextStyle(
                                  fontSize: 14.sp, color: const Color(0xff3E4040)),
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: const Color(0xffFAFAFA),
                                          border:
                                          Border.all(color: controller.color)),
                                      child: Center(
                                        child: SvgPicture.asset(
                                          "assets/audio.svg",
                                          color: const Color(0xffC6C6C6),
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              style:  TextStyle(
                                  fontSize: 14, color: enable?const Color(0xff3E4040): Colors.grey),
                              decoration: InputDecoration(
                          ...
                          InkWell(
                            onTap: () async {
                              await controller
                                  .updateLink( category: category,jobId: widget.id,imageList:imageName)
                                  .then((value) async {
